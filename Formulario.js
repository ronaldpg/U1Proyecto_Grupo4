...
// Custom Element: <runaway-formulario></runaway-formulario>

class RunawayFormulario extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <style>
            ...
            <div class="form-viaje-container">
                ...
                <div class="form-resultado-box"></div>
            </div>
        `;

        const form = this.querySelector('.form-viaje');
        const resultado = this.querySelector('.form-resultado-box');
...
customElements.define('runaway-formulario', RunawayFormulario);